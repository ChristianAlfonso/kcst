        ...
        <div class="container d-flex mt-5" style="height: auto; width: 50rem;" id="objective-content">
            ...
            <div class="box p-3 d-flex justify-content-center align-items-start flex-column text-light" style="flex: 1;">
                ...
                <p class="text-justify">
                    1. To provide moral, intellectual training and upright living in a christian atsmosphere. <br> <br>
                2. To contribute the students' potentials by efficient and responsible professional.</p>
            </div>
        </div>
    </div>
