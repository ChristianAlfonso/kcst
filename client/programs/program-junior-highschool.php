        ...
        <div class="container-fluid d-flex justify-content-center align-items-center p-3 text-white" style="min-height: 100vh" id="objective">
            <div class="container-fluid mt-5">
                ...
                <div class="img-title container"> 
                    ...
                    <p>The Junior and Senior High School program provides students with a strong academic foundation and specialized learning tracks to prepare them for higher education, employment, or entrepreneurship. Junior High School (Grades 7-10) focuses on core subjects and skill development, while Senior High School (Grades 11-12) offers academic, technical-vocational, and arts and sports tracks, equipping students with the competencies needed for future success.</p>
                    <ul>
