        ...
        <div class="container-fluid d-flex justify-content-center align-items-center p-3 text-white" style="min-height: 100vh" id="objective">
            <div class="container-fluid mt-5">
                ...
                <div class="img-title container"> 
                    <h2 class="text-center mt-2">BASIC EDUCATION</h2>
                    <p>The Basic Education program provides foundational learning from early childhood to secondary education, equipping students with essential knowledge, skills, and values. It covers core subjects such as language, mathematics, science, and social studies, fostering critical thinking, creativity, and personal development. The program prepares students for higher education, employment, and lifelong learning.</p>
                    <ul>
