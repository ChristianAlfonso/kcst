        ...
        <div class="container-fluid d-flex justify-content-center align-items-center p-3 text-white" style="min-height: 100vh" id="objective">
            <div class="container-fluid mt-5">
                ...
                <div class="img-title container"> 
                    <h2 class="text-center mt-2">BS HOSPITALITY</h2>
                    <p>The BSHM program equips students with the knowledge and skills needed for careers in the hospitality and tourism industry. It covers hotel and restaurant management, food and beverage service, event planning, tourism operations, and customer service. The program emphasizes hands-on training, business management, and global industry standards, preparing graduates for leadership roles in hotels, resorts, cruise lines, and other hospitality establishments.</p>
                    <ul>
