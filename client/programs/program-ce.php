        ...
        <div class="container-fluid d-flex justify-content-center align-items-center p-3 text-white" style="min-height: 100vh" id="objective">
            <div class="container-fluid mt-5">
                ...
                <div class="img-title container"> 
                    <h2 class="text-center mt-2">BS COMPUTER ENGINEERING</h2>
                    <p>The BSCpE program integrates computer science and electrical engineering to design and develop hardware and software systems. It covers programming, embedded systems, microprocessors, networking, artificial intelligence, and cybersecurity. The program emphasizes innovation, problem-solving, and hands-on applications, preparing graduates for careers in computer hardware design, software development, robotics, and IT infrastructure.</p>
                    <ul>
