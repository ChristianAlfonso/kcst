        ...
        <div class="container-fluid d-flex justify-content-center align-items-center p-3 text-white" style="min-height: 100vh" id="objective">
            <div class="container-fluid mt-5">
                ...
                <div class="img-title container"> 
                    <h2 class="text-center mt-2">BS CRIMINOLOGY</h2>
                    <p>The BSCrim program focuses on the study of crime, law enforcement, forensic science, and the justice system. It covers criminal investigation, law, corrections, and crime prevention strategies. The program prepares students for careers in law enforcement, forensic analysis, security management, and other criminal justice-related fields, promoting public safety and justice.</p>
                    <ul>
