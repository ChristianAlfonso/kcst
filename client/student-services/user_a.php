...
<body>
    ...
    <div class="landing">
        ...
        <div class="container-fluid vh-100 d-flex justify-content-center align-items-center" id="objective">
            <div class="announcements bg-light p-3 container rounded-3" style="max-height: 60vh; overflow-y: auto;">
                <h2 class="text-center display-2 fw-bold" style="color: #7E7F31; font-family: Rubik Mono One;">ANNOUNCEMENTS</h2>
                <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<div class='announcement card border p-3 rounded-3 mt-3'>";
                        echo "<h1  style='font-family: Alfa Slab One;'>" . htmlspecialchars($row['title']) . "</h1>";
