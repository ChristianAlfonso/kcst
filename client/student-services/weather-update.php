...
<!--Navbar Offcanvas-->
        ...
        <div class="container-fluid d-flex justify-content-center align-items-center" id="other-process" style="min-height: 100vh;flex-wrap: wrap; gap: 1rem; padding-top: 5rem;">
            <iframe src="https://www.pagasa.dost.gov.ph/regional-forecast/nlprsd" width="500" height="700" style="border:none;overflow:hidden" scrolling="yes" frameborder="0" allowfullscreen="true"></iframe>
        </div>
