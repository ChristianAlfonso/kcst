    ...
    <div class="admin-post d-flex">
        ...
        <div class="main border flex-grow-1 p-5">
            <div class="main-header d-flex justify-content-between align-items-center">
                <h2 style="color: #808131">Delete Event</h2>
                <button type="button" class="navbar-toggler" data-bs-toggle="offcanvas" data-bs-target="#responsiveSidebar">
                    <span class="navbar-toggler-icon"></span>
                </button>
            </div>
            <div class="main-body mt-4">
                <div class="container p-2 shadow-sm d-flex justify-content-center align-items-center mt-4" style="gap: 1rem; flex-wrap: wrap;">
                    <?php
